...
| [`kubernetes`](kubernetes)     | Kubernetes deployment examples including raw manifests (DinD, rootless), Flux CD / GitOps workflows with OCI HelmReleases, and KEDA-based autoscaling. See the [Kubernetes README](kubernetes/README.md) for all options.   |
